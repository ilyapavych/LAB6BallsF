...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"f43f382f-fb3f-42ef-996d-896016d3ec3b\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [27 x i8] c"com.companyname.lab6ballsf\00", align 16
...
@__DSOCacheEntry_name.2 = internal constant [25 x i8] c"libaot-LAB6BallsF.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 1
	%struct.DSOCacheEntry {
		i64 43063316777954540, ; hash 0x98fddbc3666cec, from name: aot-LAB6BallsF
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 2
	%struct.DSOCacheEntry {
	...
	; 14
	%struct.DSOCacheEntry {
		i64 482099381208532413, ; hash 0x6b0c2d53b5ec5bd, from name: LAB6BallsF
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 108
	%struct.DSOCacheEntry {
		i64 4535235544518096931, ; hash 0x3ef064b2f3b9f823, from name: aot-LAB6BallsF.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 139
	%struct.DSOCacheEntry {
		i64 6553993123046303039, ; hash 0x5af476055787253f, from name: libaot-LAB6BallsF
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 282
	%struct.DSOCacheEntry {
		i64 11765488388961885448, ; hash 0xa347695a810e5d08, from name: libaot-LAB6BallsF.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 402
	%struct.DSOCacheEntry {
		i64 16216078709161907353, ; hash 0xe10b15ab655ed499, from name: LAB6BallsF.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
